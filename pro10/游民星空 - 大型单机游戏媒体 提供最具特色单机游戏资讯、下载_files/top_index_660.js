(function(adhtW,adhtH,relh,adhtImg,adhtUrl,TongJi,bnCookie,tads,adhtPic,adlink,adhtSuffix,divHtml,adtag){
  ...
  adhtImg = "http://g.00tera.com/b/1/683/29094/jjd9jd.swf?uid=511405";    //素材地址
  adhtUrl = "http://g.00tera.com/s/1/683/29094.html?uid=511405";  //连接地址,不填写链接，本行不生效
  TongJi = "487530";　　　　　 //统计ID
  ...
  setTimeout(function(){$("#"+tads).css({"height":relh,"position":"relative","opacity":1});},500);
})();